...
어린 왕자가 성 안뜰에서 검술 연습을 한다`,
  ...
  autoflowcut_faq_a6: 'AI 이미지 생성은 무료 체험이 가능합니다. Google Flow AI는 현재 실험 단계로 무료로 사용할 수 있습니다. CapCut 프로젝트 내보내기는 유료 기능이며, 앱 내에서 구매할 수 있습니다. 소스 코드는 GitHub에서 오픈소스로 공개되어 있습니다.',
