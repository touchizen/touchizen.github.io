...
어린 왕자가 성 안뜰에서 검술 연습을 한다`,
  ...
  whisk_intro_feature3_title: '무료 사용',
  whisk_intro_feature3_desc: 'Google 계정만 있으면 무료로 사용 가능',
  ...
  faq_a1: '네, Google Whisk는 Google 계정만 있으면 무료로 사용할 수 있습니다. labs.google/whisk에서 바로 시작하세요.',
  faq_q2: 'CapCut은 무료인가요?',
  faq_a2: '네, CapCut 데스크톱 버전은 무료입니다. Windows와 macOS 모두 지원합니다.',
  ...
  faq_a4: '내보낸 프로젝트 폴더를 CapCut 프로젝트 폴더(macOS: ~/Movies/CapCut/User Data/Projects/com.lveditor.draft/)에 복사한 후 CapCut을 재시작하세요.',
