export const ja = {
  ...
  export_opt1_desc: 'CapCutプロジェクトフォルダパス（フォルダ名または絶対パス）',
...
若い王子が中庭で剣術の稽古をする`,
  ...
  faq_a4: 'エクスポートされたプロジェクトフォルダをCapCutプロジェクトフォルダ（macOS: ~/Movies/CapCut/User Data/Projects/com.lveditor.draft/）にコピーして、CapCutを再起動してください。',
