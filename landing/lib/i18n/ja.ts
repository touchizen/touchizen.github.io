export const ja = {
  ...
  whisk2capcut_what_desc: 'Whisk2CapCutは、Google Labs Whisk AI画像生成とCapCut動画編集を連携するChrome拡張機能です。一貫したスタイルで複数のAI画像を生成し、Ken Burns効果（ズームイン/アウト）が適用された動く動画に即座に変換します。画像ダウンロードだけの単純な自動化ツールとは異なり、タイムライン付きの完全なCapCut動画プロジェクトを作成します。',
  ...
  pricing_free_desc: '5回または7日間',
  pricing_free_feature1: '5回CapCutエクスポート',
  pricing_free_feature2: '7日間トライアル',
...
若い王子が中庭で剣術の稽古をする`,
  ...
  privacy_safety_subtitle: 'データは常にブラウザ内に保持されます。',
  ...
  privacy_safety_feature2_title: 'ブラウザのみで動作',
  privacy_safety_feature2_desc: 'この拡張機能は100%ブラウザ内で動作します。創作物がデバイスを離れることはありません。',
