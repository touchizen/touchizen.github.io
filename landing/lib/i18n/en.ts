...
The young prince practices sword fighting in the courtyard`,
  ...
  whisk_intro_feature3_title: 'Free to Use',
  whisk_intro_feature3_desc: 'Free to use with just a Google account',
  ...
  faq_a1: 'Yes, Google Whisk is free to use with just a Google account. Get started at labs.google/whisk.',
  faq_q2: 'Is CapCut free?',
  faq_a2: 'Yes, CapCut desktop version is free. It supports both Windows and macOS.',
  ...
  faq_a4: 'Copy the exported project folder to the CapCut projects folder (macOS: ~/Movies/CapCut/User Data/Projects/com.lveditor.draft/) and restart CapCut.',
