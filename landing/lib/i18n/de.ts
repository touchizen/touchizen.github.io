...
Der junge Prinz übt im Burghof Schwertkampf`,
  ...
  whisk_intro_feature3_title: 'Kostenlos nutzbar',
  whisk_intro_feature3_desc: 'Kostenlos nutzbar mit nur einem Google-Konto',
  ...
  faq_a1: 'Ja, Google Whisk ist mit nur einem Google-Konto kostenlos nutzbar. Starten Sie unter labs.google/whisk.',
  faq_q2: 'Ist CapCut kostenlos?',
  faq_a2: 'Ja, die CapCut Desktop-Version ist kostenlos. Sie unterstützt Windows und macOS.',
  ...
  faq_a4: 'Kopieren Sie den exportierten Projektordner in den CapCut-Projektordner (macOS: ~/Movies/CapCut/User Data/Projects/com.lveditor.draft/) und starten Sie CapCut neu.',
