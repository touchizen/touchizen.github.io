            ...
            <div className="prose dark:prose-invert max-w-none">
              {lang === 'ko' ? (
                <>
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">3. AutoFlowCut MCP 서버</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    AutoFlowCut은 Claude AI를 위한 MCP(Model Context Protocol) 서버로, AI 기반 영상 제작 도구입니다.
                  </p>
                  <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">무료 클라이언트 (100% 오픈소스)</h3>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                    <li>모든 처리가 사용자의 로컬 기기에서 이루어집니다</li>
                    <li>프로젝트 데이터는 기기에만 저장되며 외부 서버로 전송되지 않습니다</li>
                    <li>개인정보를 수집하지 않습니다</li>
                  </ul>
                  <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">Pro 버전 (유료 회원제)</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Pro 버전은 다음과 같은 데이터를 수집합니다:
                  </p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">4. Calorie Shot 모바일 앱</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">5. Google API 서비스 사용자 데이터 정책</h2>
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">6. 제3자 서비스</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">7. 개인정보의 처리 및 보유 기간</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">8. 정보주체의 권리·의무</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">9. 처리하는 개인정보 항목</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">10. 개인정보의 파기</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    터치즌은 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다.
                  </p>

                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">11. 쿠키 사용</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    터치즌은 정보주체의 이용정보를 저장하고 수시로 불러오는 &apos;쿠키&apos;를 사용하지 않습니다.
                  </p>

                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">12. 개인정보 보호책임자</h2>
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">13. 개인정보 처리방침 변경</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                <>
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">3. AutoFlowCut MCPサーバー</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    AutoFlowCutは、Claude AI向けのMCP（Model Context Protocol）サーバーで、AI駆動の動画制作ツールです。
                  </p>
                  <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">無料クライアント（100%オープンソース）</h3>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                    <li>すべての処理はユーザーのローカルデバイスで行われます</li>
                    <li>プロジェクトデータはデバイスにのみ保存され、外部サーバーに送信されません</li>
                    <li>個人情報は収集しません</li>
                  </ul>
                  <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">Pro版（有料会員制）</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Pro版は以下のデータを収集します：
                  </p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">4. Calorie Shotモバイルアプリ</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">5. Google APIサービスユーザーデータポリシー</h2>
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-6">
                    <p className="text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">6. サードパーティサービス</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">7. 保持期間</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">8. データ主体の権利</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    いつでも以下の権利を行使できます：
                  </p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">9. 収集する個人情報</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">10. 個人情報の廃棄</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Touchizenは、処理目的が達成された場合、遅滞なく個人情報を廃棄します。
                  </p>

                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">11. クッキー</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Touchizenは、ユーザー情報を保存・取得するためのクッキーを使用しません。
                  </p>

                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">12. プライバシー責任者</h2>
                  <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-6">
                    <p className="text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">13. プライバシーポリシーの変更</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                <>
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">3. AutoFlowCut MCP-Server</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    AutoFlowCut ist ein MCP-Server (Model Context Protocol) für Claude AI, ein KI-gestütztes Videoproduktions-Tool.
                  </p>
                  <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">Kostenloser Client (100% Open Source)</h3>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                  ...
                  <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">Pro-Version (kostenpflichtiges Abonnement)</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Die Pro-Version erhebt folgende Daten:
                  </p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">4. Calorie Shot Mobile App</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">5. Google API-Dienste Nutzerdatenrichtlinie</h2>
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-6">
                    <p className="text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">6. Drittanbieter-Dienste</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">7. Aufbewahrungsfrist</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">8. Rechte der Betroffenen</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">9. Erhobene personenbezogene Daten</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">10. Löschung personenbezogener Daten</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Touchizen löscht personenbezogene Daten unverzüglich, wenn der Verarbeitungszweck erreicht wurde.
                  </p>

                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">11. Cookies</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Touchizen verwendet keine Cookies zur Speicherung und Abfrage von Benutzerinformationen.
                  </p>

                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">12. Datenschutzbeauftragter</h2>
                  <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-6">
                    <p className="text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">13. Änderungen der Datenschutzrichtlinie</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                <>
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">3. AutoFlowCut MCP Server</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    AutoFlowCut is an MCP (Model Context Protocol) server for Claude AI, an AI-powered video creation tool.
                  </p>
                  <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">Free Client (100% Open Source)</h3>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                  ...
                  <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">Pro Version (Paid Membership)</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    The Pro version collects the following data:
                  </p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">5. Google API Services User Data Policy</h2>
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-6">
                    <p className="text-gray-700 dark:text-gray-300">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">6. Third-Party Services</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">7. Retention Period</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">8. Rights of Data Subjects</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">9. Personal Information Collected</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">10. Destruction of Personal Information</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">12. Privacy Officer</h2>
                  <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-6">
                    <p className="text-gray-700 dark:text-gray-300">
                      <strong>Name:</strong> Gookwhan Ahn<br />
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">13. Changes to Privacy Policy</h2>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
