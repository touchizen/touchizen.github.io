              ...
              <ul className="space-y-3 mb-8">
                {plan.features.map((feature, i) => (
                  <li key={i} className="flex items-center gap-3">
                    <svg
                      className={`w-5 h-5 flex-shrink-0 ${plan.highlighted ? 'text-white' : 'text-cyan-500'}`}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden overflow-x-auto">
            <table className="w-full min-w-[500px]">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr>
                  <td className="px-4 py-4 text-sm text-gray-700 dark:text-gray-300">
                    {lang === 'ko' ? 'T2V / I2V 비디오 생성' : lang === 'ja' ? 'T2V / I2V動画生成' : lang === 'de' ? 'T2V / I2V Video-Generierung' : 'T2V / I2V Video Generation'}
                  </td>
                  <td className="px-4 py-4 text-center">
                ...
                <tr>
                  <td className="px-4 py-4 text-sm text-gray-700 dark:text-gray-300">
                    {lang === 'ko' ? 'Ken Burns 효과 + 자막 자동 삽입' : lang === 'ja' ? 'Ken Burnsエフェクト + 字幕自動挿入' : lang === 'de' ? 'Ken Burns Effekt + Auto-Untertitel' : 'Ken Burns Effect + Auto Subtitle'}
                  </td>
                  <td className="px-4 py-4 text-center">
                    <svg className="w-5 h-5 text-green-500 mx-auto" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <tfoot>
                <tr className="bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 border-t-2 border-cyan-200 dark:border-cyan-800">
