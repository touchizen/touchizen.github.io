...
function generateJsonLd(lang: Language) {
  ...
  const softwareApp = {
    ...
    offers: {
      ...
      priceCurrency: 'USD',
      description: ({
        en: 'Free to download and open source (AGPL v3). Includes 5 project exports/month + 5 signup bonus. Pro: $9.99/mo, or $49.99/yr as a founding-member price through September 30, 2026 (regularly $99.99/yr) — locked in for as long as your subscription stays active. Flow login offers free generation on a low-cost subscription; API mode is billed by Google.',
        ko: '무료 다운로드 및 오픈소스(AGPL v3). 프로젝트 내보내기 월 5회 + 가입 보너스 5회 포함. Pro는 월 $9.99, 연간은 2026년 9월 30일까지 파운딩 멤버 가격 $49.99(정가 $99.99)이며 구독을 유지하는 동안 이 가격이 유지됩니다. Flow 로그인은 저비용 구독으로 무료 생성, API 모드는 Google에 직접 과금됩니다.',
        ja: '無料ダウンロード＆オープンソース(AGPL v3)。プロジェクトエクスポート月5回 + 登録ボーナス5回付き。Proは月額$9.99、年額は2026年9月30日までファウンディングメンバー価格$49.99(通常$99.99)で、サブスクリプションを継続する限りこの価格が維持されます。Flowログインは低コストのサブスクで無料生成、APIモードはGoogleから直接請求されます。',
        de: 'Kostenloser Download und Open Source (AGPL v3). Enthält 5 Projekt-Exporte/Monat + 5 Anmelde-Bonus. Pro: $9,99/Mo oder $49,99/Jahr als Gründerpreis bis zum 30. September 2026 (regulär $99,99/Jahr) — dauerhaft gesichert, solange dein Abo aktiv ist. Flow-Login bietet kostenlose Generierung im günstigen Abo; API-Modus wird von Google berechnet.',
      })[lang],
    },
