...
function generateJsonLd(lang: Language) {
  ...
  const softwareApp = {
    ...
    offers: {
      ...
      priceCurrency: 'USD',
      description: ({
        en: 'Free to download. Includes 5 CapCut exports/month + 5 signup bonus. Pro: $4.99/mo or $39.99/yr for unlimited exports. Google API usage is billed by Google.',
        ko: '무료 다운로드. CapCut 내보내기 월 5회 + 가입 보너스 5회 포함. Pro는 월 $4.99 또는 연 $39.99로 내보내기 무제한. Google API 사용량은 Google 계정에 직접 과금됩니다.',
        ja: '無料ダウンロード。CapCutエクスポート月5回 + 登録ボーナス5回付き。Proは月額$4.99または年額$39.99でエクスポート無制限。Google API利用料はGoogleから直接請求されます。',
        de: 'Kostenloser Download. Enthält 5 CapCut-Exporte/Monat + 5 Anmelde-Bonus. Pro: $4,99/Mo oder $39,99/Jahr für unbegrenzte Exporte. Google API-Nutzung wird direkt von Google berechnet.',
      })[lang],
    },
