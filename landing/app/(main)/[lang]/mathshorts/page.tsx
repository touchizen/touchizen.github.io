...
const COPY: Record<Language, Copy> = {
  ko: {
    ...
    features: [
      ...
      { icon: '🧊', title: '구와 나선은 3차원으로', desc: 'x²+y²+z²=r² 을 넣으면 구면나선이 감긴 구가 나옵니다. 가까운 쪽이 밝고, 앞선이 지나는 자리에서 뒷선이 끊깁니다. 로런츠 힘은 자기장을 따라 감기는 나선으로 그립니다.' },
  ...
  en: {
    ...
    features: [
      ...
      { icon: '🧊', title: 'Spheres and helices in 3D', desc: 'Type x²+y²+z²=r² and a spherical spiral winds a sphere into view — the near side brighter, back strands breaking where the front ones cross. The Lorentz force is drawn as a helix winding along the field.' },
  ...
  ja: {
    ...
    features: [
      ...
      { icon: '🧊', title: '球と螺旋は3次元で', desc: 'x²+y²+z²=r² を入力すると、球面螺旋が巻かれた球が現れます。手前は明るく、前の線が通る所で後ろの線が途切れます。' },
  ...
  de: {
    ...
    features: [
      ...
      { icon: '🧊', title: 'Kugeln und Helices in 3D', desc: 'Tippen Sie x²+y²+z²=r² — eine Kugelspirale wickelt eine Kugel auf: die nahe Seite heller, hintere Linien brechen an den vorderen. Die Lorentzkraft wird als Helix entlang des Feldes gezeichnet.' },
...
export default function MathShortsPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <ScreenshotGallerySection lang={lang} />
